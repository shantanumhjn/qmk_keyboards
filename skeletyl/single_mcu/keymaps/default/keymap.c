...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
   RGB_TOG, RGB_M_T,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  // If console is enabled, it will print the matrix position and status of each key pressed
    ...
    uprintf("rgb - enabled: %u, mode: %u, hue: %u, sat: %u, val: %u\n", rgblight_is_enabled(), rgblight_get_mode(), rgblight_get_hue(), rgblight_get_sat(), rgblight_get_val());
#endif 
  return true;
}
